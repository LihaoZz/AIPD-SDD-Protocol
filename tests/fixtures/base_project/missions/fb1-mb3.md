...
- `parent_fb_id`: fb1
- `status`: ready
- `change_type`: retry_success

## Parent FB Alignment

- `parent_fb_ontology_ref`: fb1
- `acceptance_slice`: write PASS_THREE into src/app.py after retry
...
- `goal`: Fail once, then pass with retry feedback
...
- `pass_condition`: PASS_THREE exists in src/app.py
...
- `machine_spec_ref`: missions/fb1-mb3.machine.json
